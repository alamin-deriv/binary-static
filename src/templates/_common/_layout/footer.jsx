            ...
            <div className='container' data-show='eucountry'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        ...
                        <p>
                            {it.L('In the Isle of Man, virtual-events-based bets on synthetic indices are offered by Deriv (MX) Ltd, Millennium House, Level 1, Victoria Road, Douglas IM2 4RW, Isle of Man, licensed and regulated by the Gambling Supervision Commission in the Isle of Man ([_1]view licence[_2]).', '<a href="https://deriv.com/regulatory/Deriv_(MX)_Ltd.pdf" target="_blank" rel="noopener noreferrer">', '</a>')}
                        </p>
                        <p>
