        ...
        <div id='footer-regulatory' className='primary-bg-color-dark gr-padding-10'>
            ...
            <div className='container' data-show='eucountry'>
                ...
                <div className='gr-row'>
                    <div className='gr-12'>
                        <p>
                            {it.L('In the EU, financial products are offered by Binary Investments (Europe) Ltd., W Business Centre, Level 3, Triq Dun Karm, Birkirkara, BKR 9033, Malta, licensed and regulated as a Category 3 Investment Services provider by the Malta Financial Services Authority ([_1]licence no. IS/70156[_2]). In the EU, financial binary options are only available to professional investors.', `<a href=${it.url_for('download/WS-Deriv-Investments-Europe-Limited.pdf')} target="_blank">`, '</a>')}
                        </p>
                        <p>
